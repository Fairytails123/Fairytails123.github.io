...
- **Owner still owes:** correcting the 20 DRAFT chip labels + 4 group names · approving Goldie · a real trackpad/phone check of the 2-viewport pin length · confirming the added homepage scroll depth.
