...
**Total: 50 grid tiles + 1 hero** (`gallery-15.webp`, the puppy-lift shot, hero band only). The three arrays (`duda` / `client` / `training`) are round-robin interleaved with feature tiles spaced ~1-in-4. Filter counts: Playtime 10 · Out & about 17 · Training 13 · Portraits 10 (12 feature tiles).
