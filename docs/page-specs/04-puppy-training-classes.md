...
12. **Puppy pathways cross-sell** — DIY Puppy Course (**TEMP → `/blog`** until page 7 ships, `TEMP:` comment) · Boarding School for Puppies £1,200 → `/dog-boarding-school` · Comprehensive Puppy Training £1,200 → `/intensive-dog-training`.
