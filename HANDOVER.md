...
- **OWNER REVIEW QUEUE — whole-dog section:** read all 20 chip labels + the 4 group names and correct them (they are drafts — esp. "Toilet habits", "Anything that seems off", "Confidence sessions") · approve **Goldie** as the centre portrait, or name a different dog · check the pin feels right on a real trackpad/phone (the pin runs for 2x viewport height — say if it's too long or too short) · confirm you're happy the section adds ~2 screens of scroll before "One place for the whole of their life".
