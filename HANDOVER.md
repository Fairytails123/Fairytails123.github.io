...
- **Deploys:** `a320354` (build) + `41e7a80` (review fixes) — Hostinger runs `29045600182` + `29046034175`, **both green first try**, no FTPS retry needed. Live-verified: 20 wires, 20 `<use>` blooms, 84 particle/spark/ripple circles, 4 `<h3>`s, outcome `visibility:visible`, `__fnl` dev hook absent, zero console errors. `verify-urls --live` 48/0.
